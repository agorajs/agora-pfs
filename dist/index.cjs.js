...
var pfs = agoraGraph.createFunction(function (graph) {
...
function delta(node1, node2) {
  ...
  if (!agoraGraph.overlap(node1, node2, {
    padding: padding
  })) return {
    x: 0,
    y: 0
  };
  return agoraGraph.diff(agoraGraph.optimalVector(node1, node2, padding), agoraGraph.vector(node1, node2));
}

exports.PFSAlgorithm = PFSAlgorithm;
exports.default = PFSAlgorithm;
exports.pfs = pfs;
